...
# Tip : Do you want to send and schedule a messages to any WhatsApp group
#then use below code and provide inside attributes value.
# pywhatkit.sendwhatmsg_to_group(GroupID, message, time_hour,
#time_min, wait_time)
